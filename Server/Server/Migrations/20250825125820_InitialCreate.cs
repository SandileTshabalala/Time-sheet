        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakHours = table.Column<decimal>(type: "numeric", nullable: true),
                    ProjectName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    TaskDescription = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    WeekEndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Timesheets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Timesheets_AspNetUsers_ApprovedById",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", null, "System Administrator", "SystemAdmin", "SYSTEMADMIN" },
                    { "2", null, "Employee", "Employee", "EMPLOYEE" },
                    { "3", null, "Manager", "Manager", "MANAGER" },
                    { "4", null, "HR Administrator", "HRAdmin", "HRADMIN" }
                });
